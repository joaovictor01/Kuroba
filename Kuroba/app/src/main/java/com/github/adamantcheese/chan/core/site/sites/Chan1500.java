...
public class Chan1500
    ...
    public void setup() {
        setBoards(
                ...
                Board.fromSiteNameCode(this, "Natureza, Animais e Agricultura", "nat"),
                ...
                Board.fromSiteNameCode(this, "Muié vestida", "muié"),
                Board.fromSiteNameCode(this, "Depressão, Relacionamentos e Casos de Família", "psico"),
